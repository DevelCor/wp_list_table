...
class Lib {
    ...
    public function ajax_user_can() {
        die( 'function Lib::ajax_user_can() must be overridden in a subclass.' );
    }

    /**
     * Prepares the list of items for displaying.
     *
     * @uses Lib::set_pagination_args()
     *
     * @since 3.1.0
     * @abstract
     */
    public function prepare_items() {
        die( 'function Lib::prepare_items() must be overridden in a subclass.' );
    }
    ...
    public function get_columns() {
        die( 'function Lib::get_columns() must be overridden in a subclass.' );
    }
    ...
    /**
     * Public wrapper for Lib::get_default_primary_column_name().
     *
     * @since 4.4.0
     *
    ...
    protected function get_primary_column_name() {
        ...
        if ( ! isset( $columns[ $default ] ) ) {
            $default = Lib::get_default_primary_column_name();
        }
    ...
    /**
     * Gets a list of CSS classes for the Lib table tag.
     *
     * @since 3.1.0
     *
